...
#
# This scripts requires three arguments:
...
#PBS -l EC_memory_per_task=100mb
 ...
 EXP=$3
 ECEDIR=${SCRATCH}/ec-earth-3/branch-varex/$EXP/output/$COMPONENT/$LEG
 ...
 ODIR=${SCRATCH}/cmorisation/cmorised-results/cmor-VAREX-cmip-$EXP/$EXP
