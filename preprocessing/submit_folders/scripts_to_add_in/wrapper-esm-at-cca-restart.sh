...
#                dir.                                                           #
#             OR use:                                                           #
PATH=$PATH:${PERM}/ec-earth-3/branch-varex-control/sources/util/ec-conf:${PERM}/ec-earth-3/branch-varex-control/sources/util/misc 
#################################################################################

MYCONFIG="ifs nemo:start_from_restart lim3 rnfmapper xios:detached oasis save_ic"
